...
<section theme="2" class="why-paleo-stories">
	<div class="center-div">
		<div class="km-h4 whyus">Gamification of paleontology by using technologies.</div>
		<a name="use-cases" />

		<div class="padding _1rem" />
		<div class="km-h3">
			Say goodbye to the traditional way of doing things. Lorem Ipsum is simply dummy text of the
		...
		{#each targetAudience as audience}
			<div class="row-why">
				<div class="why-item">
					<div class="km-h4">{audience[0].title}</div>
					<div class="line-white why" />
					<div class="km-p">{audience[0].desc}</div>
				</div>
				<div class="why-item">
					<div class="km-h4 title-experience">{audience[1].title}</div>
					<div class="line-white why" />
					<div class="km-p">
						{audience[1].desc}
					</div>
